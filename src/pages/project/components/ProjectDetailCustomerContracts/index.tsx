...
const ProjectDetailCustomerContracts: React.FC<{
  tabKey: string;
  ...
  const columns: ProColumns[] = [
    ...
    },
    {
      ...
      width: 276,
      hideInTable: !(
        access[PermissionEnum.PROJECT_DETAIL_CUSTOMER_CONTRACTS_VIEW] ||
        access[PermissionEnum.PROJECT_DETAIL_CUSTOMER_CONTRACTS_DOWNLOAD] ||
        access[PermissionEnum.PROJECT_DETAIL_CUSTOMER_CONTRACTS_HISTORY] ||
        access[PermissionEnum.PROJECT_DETAIL_CUSTOMER_CONTRACTS_REJECT] ||
        access[PermissionEnum.PROJECT_DETAIL_CUSTOMER_CONTRACTS_PASS] ||
        access[PermissionEnum.PROJECT_DETAIL_CUSTOMER_CONTRACTS_DELETE]
      ),
      render: (_, record) => {
        const operationList = [
          access[PermissionEnum.PROJECT_DETAIL_CUSTOMER_CONTRACTS_VIEW]
          ...
          record.contractStatus === ContractStatusEnum.UNDER_REVIEW
            ...
            : null,
          access[PermissionEnum.PROJECT_DETAIL_CUSTOMER_CONTRACTS_TERMINATE] &&
...
export default ProjectDetailCustomerContracts;
