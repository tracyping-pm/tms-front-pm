    ...
    <>
      ...
      >
        ...
        >
          ...
          <Space size={12}>
            <Access
              accessible={access[PermissionEnum.REFUND_TICKET_DETAIL_ADD_PROOF]}
            >
              <Button
                size="small"
            ...
            <Access
              accessible={
                access[PermissionEnum.REFUND_TICKET_DETAIL_ADD_REMARK]
              }
            >
              <Button
                size="small"
            ...
            <Access
              accessible={
                access[PermissionEnum.REFUND_TICKET_DETAIL_EDIT_OC_STATUS]
              }
            >
              <Button
                size="small"
