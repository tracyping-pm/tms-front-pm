...
export default function BilledAmountHeader({
  ...
  const fetchDetail = async () => {
    ...
    if (res.code === 200) {
      setDetailStatus(res.data?.status as CustomerStatementStatusEnum);
    }
  };
          ...
          {editStatus ? (
            ...
            <Access
              ...
              accessible={
                access[
                  PermissionEnum
                    .CUSTOMER_STATEMENT_DETAIL_WAYBILL_BILLED_AMOUNT_EDIT
                ]
              }
            >
              {[
          ...
          {editReimbursementStatus ? (
            ...
            <Access
              ...
              accessible={
                access[
                  PermissionEnum
                    .CUSTOMER_STATEMENT_DETAIL_WAYBILL_EDIT_REIMBURSEMENT_EXPENSE
                ]
              }
            >
              {[
