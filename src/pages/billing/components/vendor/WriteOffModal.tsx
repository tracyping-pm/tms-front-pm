        ...
        title={
          <>
            ...
            <CustomTooltip
              ...
              title={
                'Write off the statement, no further payment will be made on the remaining amount, and all items within the statement will be marked as settled.'
              }
            >
      ...
      >
        ...
        >
          ...
          <ProFormSelect
            ...
            name="type"
            options={[
              { value: 'Vendor', label: 'Vendor Reason' },
