  ...
  (
              ...
              <Popover
                ...
                content={
                  <>
                    ...
                    <div className={styles.tableDescribe_notes}>
                      Customer claim is not empty, vendor claim is empty：
                      <span style={{ color: '#faad14' }}>0.00</span>
                    </div>
                    <div className={styles.tableDescribe_notes}>
    ...
    const columns: ProColumns[] = [
      ...
      },
      {
        ...
        render: (_, record) => {
          const { paidInAdvanceStatus, paidInAdvance } = record;
          const content =
      ...
      },
      {
        ...
        render: (_, record) => {
          const { regularPaymentsStatus, regularPayments } = record;
          const content =
      ...
      },
      {
        ...
        render: (_, record) => {
          ...
          const isEdit =
            record.paidInAdvanceStatus === BasicAmountStatusEnum.VERIFIED ||
            record.regularPaymentsStatus === BasicAmountStatusEnum.VERIFIED;
          return (
            <>
              <CustomTooltip title={content} rootClassName={styles.tooltipCls}>
                {content}
              ...
              >
                ...
                >
                  ...
                  ].includes(detail?.status as VendorStatementStatusEnum) && (
                    <EditOutlined
                      className={cls(
      ...
      },
      {
        ...
        render: (_, record) => {
          ...
          //     VendorStatementStatusEnum.AWAIT_VENDOR_CONFIRM,
          //     VendorStatementStatusEnum.AWAITING_REBILL,
          //   ].includes(record.status as VendorStatementStatusEnum) && (
          // <Tooltip
          //   title={
          //     isEdit
          //       ? null
    ...
    return (
      <div id={BILLING_DETAIL_ANCHOR_ID_MAP.VENDOR_WAYBILL_LIST}>
            ...
            <CommonTitle
              ...
              tooltip={
                isCreatePage ? (
                  ...
                  <div>
                    <div>
                      Contract Cost = Basic amount Receivable + Vendor
                      Additional Charge + Vendor Exception Fee (When these fees
                      are settled in this statement.)
                    </div>
                    <div>
                      VAT=（ Contract Cost +Miscellaneous Charge）* Tax Rate
                    </div>
                    <div>
                      WHT=（ Contract Cost +Miscellaneous Charge）* Tax Rate
                    </div>
                  </div>
                )
              }
                ...
                <Space size={24}>
                  {/* <Access
                    ...
                    accessible={
                      access[
                        PermissionEnum
                          .VENDOR_STATEMENT_DETAIL_WAYBILL_EDIT_CHARGE_HISTORY
                      ] && !isCreatePage
                    }
                  >
                    <CustomStatusButton
                  ...
                  <Access
                    ...
                    accessible={
                      access[
                        PermissionEnum
                          .VENDOR_STATEMENT_DETAIL_ASSOCIATED_WAYBILL
                      ] &&
                      !isCreatePage &&
                      [
                        VendorStatementStatusEnum.UNDER_PAYMENT_PREP,
                  ...
                  <Access
                    ...
                    accessible={
                      access[
                        PermissionEnum
                          .VENDOR_STATEMENT_DETAIL_WAYBILL_BILLED_AMOUNT
                      ] && !isCreatePage
                    }
                  >
                    <CustomStatusButton
                      ...
                      onClick={() => {
                        history.push(
                          `${PATHS.BILLING_VENDOR_STATEMENT_BILLED_AMOUNT}/${statementId}`,
                        );
                      }}
                    >
                      Billed Amount
                  ...
                  <Access
                    ...
                    accessible={
                      access[
                        PermissionEnum
                          .VENDOR_STATEMENT_DETAIL_WAYBILL_EDIT_INVOICE
                      ] &&
                      !isCreatePage &&
                      [
                        VendorStatementStatusEnum.UNDER_PAYMENT_PREP,
                  ...
                  <Access
                    ...
                    accessible={
                      access[
                        PermissionEnum
                          .VENDOR_STATEMENT_DETAIL_WAYBILL_FILL_IN_ALL_INVOICE
                      ] &&
                      !isCreatePage &&
                      [
                        VendorStatementStatusEnum.UNDER_PAYMENT_PREP,
