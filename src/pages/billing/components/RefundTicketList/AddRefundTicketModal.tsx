...
const AddClaimTicketModal: FC<IAddClaimTicketModal> = ({
  ...
  const onOk = async () => {
    ...
    if (res.code === 200) {
      message.success('Add refund ticket successfully!');
      onRefresh?.();
      onCancel?.();
    }
  };
    ...
    <>
      ...
      >
        <div className={styles.tips}>
          {`Only Refund Tickets ${statementType === 'AR' ? 'of this client' : 'confirmed by this supplier'} can be added, and they must not be
