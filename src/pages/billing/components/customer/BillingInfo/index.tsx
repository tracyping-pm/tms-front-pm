...
import styles from '@/pages//billing/components/customer/BillingInfo/styles.less';
...
import CreateClaimRequestModal from '../../CreateClaimRequestModal';
...
export default function BillingInfo({ detail, loading }: IBillingInfo) {
  ...
  const [miscellaneousList, setMiscellaneousList] = useState<
    IStatementMiscellaneousChargeListItem[]
  >([]);
  const [createClaimRequestOpen, setCreateClaimRequestOpen] =
    useState<boolean>(false);
  ...
  const onEditMiscellaneousModalConfirm = async (
    payload: IMiscellaneousChangeSaveReq,
  ) => {
    setMiscellaneousLoading(true);
    const res = await miscellaneousChangeSave(payload);
    setMiscellaneousLoading(false);
    if (res.code === 200) {
  ...
  return (
    <Spin spinning={loading || refreshLoading}>
      <div className={styles.info}>
              ...
              <>
                <Access
                  ...
                  accessible={
                    access[
                      PermissionEnum
                        .CUSTOMER_STATEMENT_DETAIL_BILLING_ADDITIONAL_CHARGE
                    ]
                  }
                >
                  <CustomStatusButton
                    ...
                    onClick={() => {
                      history.push(
                        `${PATHS.BILLING_CUSTOMER_ADDITIONAL}/${statementId}`,
                      );
                    }}
                  >
                ...
                <Access
                  ...
                  accessible={
                    access[
                      PermissionEnum
                        .CUSTOMER_STATEMENT_DETAIL_BILLING_CLAIM_TICKET_DETAIL
                    ]
                  }
                >
                  <CustomStatusButton
                    ...
                    onClick={() => {
                      history.push(
                        `${PATHS.BILLING_CUSTOMER_CLAIMS_TICKET}/${statementId}`,
                      );
                    }}
                    type="link"
                  >
                ...
                <Access
                  key="createClaimRequest"
                  accessible={
                    access[
                      PermissionEnum
                        .CUSTOMER_STATEMENT_DETAIL_BILLING_CREATE_CLAIM_REQUEST
                    ]
                  }
                >
                  {[
                    ...
                    <CustomStatusButton
                      className={styles.info_header_right_btn}
                      onClick={() => {
                        setCreateClaimRequestOpen(true);
                      }}
                    >
              ...
              <>
                <Access
                  ...
                  accessible={
                    access[
                      PermissionEnum
                        .CUSTOMER_STATEMENT_DETAIL_BILLING_EDIT_CHARGE_HISTORY
                    ]
                  }
                >
                  <CustomStatusButton
                ...
                <Access
                  ...
                  accessible={
                    access[
                      PermissionEnum
                        .CUSTOMER_STATEMENT_DETAIL_BILLING_EDIT_CHARGE
                    ] &&
                    [
                      CustomerStatementStatusEnum.UNDER_BILLING_PREP,
                      CustomerStatementStatusEnum.AWAIT_CUSTOMER_CONFIRM,
            ...
            <div className={styles.infoHeader}>
              ...
              >
                <div className={styles.info_table_title}>
                  ...
                  <CustomTooltip
                    title="Total Amount Receivable = Waybill Contract Revenue - Claim + Others"
                    placement="top"
                  >
                    {detail?.billingInfo?.basedOnWaybill ? (
                      <InfoCircleOutlined
              ...
              <Access
                ...
                accessible={
                  access[
                    PermissionEnum
                      .CUSTOMER_STATEMENT_DETAIL_BILLING_IS_TAX_INCLUSIVE
                  ]
                }
              >
                {detail.billingInfo?.basedOnWaybill &&
              ...
              {detail?.billingInfo?.basedOnWaybill ? (
                <>
                  ...
                  >
                    ...
                    <div>
                      {typeof detail?.billingInfo?.basicAmount === 'number' ? (
                        <div className={styles.info_table_item}>
                          ...
                          <div className={styles.info_table_num}>
                            {CountryCurrencyEnumText[countryId as number]}
                            {formatAmountPercentage(
                              detail?.billingInfo?.basicAmount,
                            )}
                          </div>
                        </div>
                      ) : null}
        ...
        {createClaimRequestOpen && (
          <CreateClaimRequestModal
            open={createClaimRequestOpen}
            customerName={detail?.customerName}
            customerId={detail?.customerId}
            onCancel={() => {
              setCreateClaimRequestOpen(false);
            }}
          />
        )}
      </div>
