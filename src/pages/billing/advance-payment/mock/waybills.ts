export type TmsWaybillItemName =
  | 'Basic Amount'
  | 'Additional Charge'
  | 'Exception Fee'
...
export interface TmsWaybill {
  ...
  linkedItemStatements?: Partial<Record<TmsWaybillItemName, string>>;
}
...
export const TMS_WAYBILLS: TmsWaybill[] = [
  ...
  },
  {
    ...
    status: 'Delivered',
    linkedItemStatements: { 'Basic Amount': 'APVS2604001' },
  },
  {
...
// Candidate waybills used in the Create form
...
export const CANDIDATE_WAYBILLS: CandidateWaybill[] = [
  { no: 'WB2604021', vendor: 'Coca-Cola Bottlers PH Inc.', status: 'In Transit', truckType: '10-Wheeler', origin: 'PH-NCR-Manila / Port Area', destination: 'PH-Cavite-Imus / DC', positionTime: '2026-04-17 09:25', unloadingTime: '2026-04-17 13:10', basicAmount: 12000 },
  { no: 'WB2604022', vendor: 'Coca-Cola Bottlers PH Inc.', status: 'Planning', truckType: '6-Wheeler', origin: 'PH-Batangas / Lima', destination: 'PH-NCR-Manila', positionTime: '2026-04-17 13:40', unloadingTime: '2026-04-17 18:05', basicAmount: 9500 },
  { no: 'WB2604030', vendor: 'SMC Logistics', status: 'In Transit', truckType: '10-Wheeler', origin: 'PH-Pampanga / Clark', destination: 'PH-NCR-Manila / Port Area', positionTime: '2026-04-18 15:20', unloadingTime: '2026-04-18 19:15', basicAmount: 20000 },
  { no: 'WB2604035', vendor: 'JG Summit Freight', status: 'Pending', truckType: '4-Wheeler', origin: 'PH-NCR-Manila', destination: 'PH-Laguna-Calamba', positionTime: '2026-04-18 07:50', unloadingTime: '2026-04-18 11:25', basicAmount: 8500 },
  { no: 'WB2604036', vendor: 'JG Summit Freight', status: 'Planning', truckType: '10-Wheeler', origin: 'PH-NCR-Manila / Port Area', destination: 'PH-Cavite-Imus / DC', positionTime: '2026-04-19 08:10', unloadingTime: '2026-04-19 12:30', basicAmount: 14000 },
  { no: 'WB2604040', vendor: 'Bangkok Express Logistics', status: 'In Transit', truckType: '10-Wheeler', origin: 'TH-Bangkok / Suvarnabhumi', destination: 'TH-Chonburi / Laem Chabang', positionTime: '2026-04-18 06:00', unloadingTime: '2026-04-18 12:00', basicAmount: 18000 },
];
