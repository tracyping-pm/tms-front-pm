    ...
    <>
      ...
      <span
        className={cls(styles.titleStepItem, {
          [styles.titleStepActive]: stepActive === 1,
        })}
      >
...
type ITemporaryStepsModal = ModalProps & {
  projectId: number;
  waybillId: number;
  initialValue: {
    routeCode: string;
...
export default TemporaryStepsModal;
