import { IVendorAnalysisByProjectVendorAnnualTrendItem } from '@/api/types/statistics';
...
interface IChartProps {
  dataSource: IVendorAnalysisByProjectVendorAnnualTrendItem[];
  type: string;
}

const Charts: FC<IChartProps> = ({ dataSource, type }) => {
  ...
  useEffect(() => {
    ...
    dataSource.forEach((item) => {
      data.mouthDate.push(item.yearMonth);
      if (type === 'waybill') {
        data.values.push(item.waybillCount);
